...
parser.add_argument('--data', type=str, required=False, default='Blast Furnace System', help='data')
parser.add_argument('--root_path', type=str, default='./data/ETT/', help='root path of the data file')
parser.add_argument('--data_path', type=str, default='Blast Furnace System.csv', help='data file')    
...
data_parser = {
    ...
    'Blast Furnace System':{'data':'Blast Furnace System.csv','T':'19','M':[39,39,39],'S':[1,1,1],'MS':[39,39,1]},
}
